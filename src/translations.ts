...
export const translations: Record<'en' | 'am', TranslationDict> = {
  ...
  am: {
    ...
    culturePara2: 'ከታዋቂው የቅዳሜ እና ማክሰኞ የማርና እህል ገበያ (ገበሬዎች ከአካባቢው ደጋ አበቦች የተቀነባበረውን ከፍተኛ ዋጋ ያለው ነጭ ኦርጋኒክ ማር የሚሸጡበት) እስከ አስደናቂው የጥምቀት የፈረሰኞች ውድድር ድረስ የጎጃም ቅርስ ህያው፣ ደህንነቱ የተጠበቀ እና እጅግ በጣም እንግዳ ተቀባይ ሆኖ ቀጥሏል።',
    ...
    // AI Chat
    chatWelcome: 'እንኳን ደህና መጡ! እኔ የድጎ ኤ አይ ረዳት ነኝ። ስለ ውቧ ጮቄ ተራራ፣ ስለ ቅዳሜ እና ማክሰኞ ገበያ፣ ስለ ፈረሰኞች ባህል ወይም ስለ ኢንቨስትመንት አማራጮች ማንኛውንም ነገር ይጠይቁኝ!',
